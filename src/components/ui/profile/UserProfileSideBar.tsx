      ...
      <CardContent className="p-6 flex flex-col items-center">
        ...
        <div className="flex w-full justify-between items-center mb-5">
          ...
          <div className="flex flex-row gap-[7.5px]">
            <Button className="w-15 h-[22.5px] px-4 text-xs bg-[#0050ef] rounded-[3.75px] cursor-pointer">
              팔로우
            </Button>
            <Button className="w-15 h-[22.5px] px-4 text-xs bg-[#555555] rounded-[3.75px] cursor-pointer">
              메시지
            </Button>
          </div>
        </div>
