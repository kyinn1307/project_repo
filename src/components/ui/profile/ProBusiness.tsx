...
export const ProBusiness = ({
  ...
  return (
    <>
      <div className="flex flex-col w-full rounded-[15px] bg-[#111111] p-[11.25px] gap-[7.5px] text-white">
        {isOtherUser ? (
          isEmpty ? (
            <div className="flex flex-col gap-[60px]">
              ...
              <div className="flex flex-col items-center gap-[7.5px] mb-[54.24px]">
          ...
          <div className="flex flex-col gap-[60px]">
            ...
            <div
              ...
              onClick={() => navigate("/business-setting/3")}
            >
              <div className="cursor-pointer">
                <BusinessUploadIcon />
              </div>
